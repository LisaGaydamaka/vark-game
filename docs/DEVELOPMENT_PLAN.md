...
**Automated:** accepted on exact `test` head `56ca278699c6536dc5131c0e6c3eb8555504cae3` in GitHub Actions run #35725403063. Gameplay Noise verifies carpet 0.09 / stone 0.35 / tile 0.90, the 0.45 crouch multiplier, 0.16 physical hearing floor, 0.30 footstep investigation floor, the carpet/stone/tile reaction matrix, and landing/mantle contact behavior. The full regression barrier passed.
