...
- active search keeps ordinary senses live during movement, pauses, turns, and held looks; new evidence still interrupts the current action immediately;
