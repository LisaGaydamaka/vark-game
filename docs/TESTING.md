...
Traversal is hidden inside normal city fabric: loaded carts, stacked crates, market stalls and tilted canopies at street level; attached shop awnings, balconies, window sills, cornices and rear fire escapes on façades; then real tilted/gabled roofs, dormers, chimneys and parapets at the upper level. The authoritative map contains at least twelve genuinely sloped roof/canopy brushes and more than twenty ordinary fixed street-item brushes. There is no dedicated route-platform brush class. The west approach climbs Mercer Row and Survey Office into the Archive high-window route; the east approach reaches the Watchmaker rooftop key room, descends its rear fire escape, then enters the locked Archive and climbs its real switchback stair/mezzanine interior.
...
1. Launch **Representative Stealth — Ledge City** and inspect the architecture before following a route. There should be no visible cracks where walls/ceilings meet, no oversized empty strips around closed entrance doors, and no room seam that exposes adjacent space/sky. The center should read as a narrow street rather than a plaza.
2. Enter the street-front buildings. Corridors/rooms should feel compact, with counters, tables, shelves, crates and other fixed detail breaking up the interiors. Doorways must look seated in their walls.
