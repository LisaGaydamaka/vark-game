...
- TrenchBroom FGD export for `vark_acoustic_space` and `vark_acoustic_portal`, including the acoustic-space editor-only bounds model and property-driven scale expression;
