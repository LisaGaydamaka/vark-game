...
- executes the independent authoring, application menu/development-launch/mission-package/definition/ownership/lifecycle/input/pause-time, props, and movement suites through that entry point;
